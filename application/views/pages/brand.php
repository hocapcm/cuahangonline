			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="row">
                            ...
                            <h2 class="title text-center">Thương hiệu - <?php echo $allproduct_brand_pagination[0]->tenthuonghieu; ?></h2>
                       

						<?php 
						foreach ($allproduct_brand_pagination as $key => $brandpro){
						?>
						<div class="col-sm-4">
							...
							<form action="<?php echo base_url('add-to-cart1') ?>" method="POST">
								...
								<div class="single-products">
										...
										<input type="hidden" value="<?php echo $brandpro->id ?>" name="product_id">	
										<input type="hidden" value="1" name="quantity">
											<a href="<?php echo base_url('san-pham/'.$brandpro->id) ?>" ><img src="<?php echo base_url('uploads/product/'.$brandpro->image) ?>" alt="<?php echo $brandpro->title ?>"/></a>
											<a href="<?php echo base_url('san-pham/'.$brandpro->id) ?>" ><?php echo $brandpro->title ?></a>
											<h2><?php echo number_format($brandpro->price, 0, ',', '.') ?>đ</h2>
