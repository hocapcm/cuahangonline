...
<div class="card">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
  <a onclick="return confirm('Are you sure?')" href="<?php echo base_url('product/delete/'.$pro->id) ?>" class="btn btn-danger">
    <i class="fas fa-trash"></i>
  </a>
  <a href="<?php echo base_url('product/edit/'.$pro->id) ?>" class="btn btn-warning">
